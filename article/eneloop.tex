...
\shorttitle{Tidal interactions between binary stars drives lithium production in low-mass red giants}
\shortauthors{Casey et al.}


\begin{document}

\title{Tidal interactions between binary stars drives lithium production in low-mass red giants}
...
\affil{Max Planck Institute for Solar System Research,
	   SAGE research group,
...
\affil{Institute for Gravitational Wave Astronomy and School of Physics and Astronomy, 
...
medium or predicted from the Big Bang. With only about 150 lithium-rich
giants discovered in the past four decades, and no distinguishing properties 
...
cannot account for the majority that have helium-burning cores. We rule out most other 
proposed explanations as the primary mechanism for lithium-rich giants, including all
stages related to single star evolution.
...
\begin{figure*}[t]
    \includegraphics[width=\textwidth]{figures/ref_li_distribution.pdf}
...
\begin{figure*}[t!]
	\includegraphics[width=\textwidth]{figures/ref_timescales.pdf}
...
\begin{figure}
	\includegraphics[width=0.5\textwidth]{figures/ref_bump_plus_8_scenario_c_grid_search.pdf}
...
\begin{figure}
	\centering
	\includegraphics[width=0.5\textwidth]{figures/fraction_wrt_mh.pdf}
	\caption{
...
%In contrast, although the radial velocity epoch measurements are not publicly available,
%in the same sample only 6 of 336 lithium-normal giants have been reported to have
%radial velocity variations \citep{Niedzielski:2011}.
